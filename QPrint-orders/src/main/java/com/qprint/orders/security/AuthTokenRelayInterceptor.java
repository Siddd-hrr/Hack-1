package com.qprint.orders.security;
...
public class AuthTokenRelayInterceptor implements ClientHttpRequestInterceptor {
    ...
    private static final List<String> ORDERS_SERVICE_SCOPES = List.of("otp:write");
    ...
    public @NonNull ClientHttpResponse intercept(@NonNull HttpRequest request,
        ...
        if (!StringUtils.hasText(token)) {
            token = serviceJwtTokenProvider.issueServiceToken(ORDERS_SERVICE_SCOPES);
        }
